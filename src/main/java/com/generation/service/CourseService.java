...
public class CourseService
{
    ...
    public void showAverageGrade(){
        ...
        System.out.println("Enter course code to view average grades: ");
            ...
            if(students != null && !students.isEmpty()){
                ...
                for(Student student : students){
                    if(student.isCourseApproved(courseCode)){
                        totalGrade += student.getCourseGrades().get(courseCode);
                    }
                }

                double averageGrade = totalGrade/totalStudents;
                System.out.println("Average Grades for course" + courseCode + ": " + averageGrade);
            } else{
                System.out.println("No students enrolled in course " + courseCode);
            }
        } else{
            System.out.println("Course with " + courseCode + " not found.");
        }
    }
